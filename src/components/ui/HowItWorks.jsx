    ...
    <section className="py-16 bg-gray-50">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 px-10">
        ...
        {steps.map((step) => (
          <div
            key={step.id}
            className="bg-white shadow-lg rounded-xl p-6 text-center w-full md:w-80"
          >

            <div className="mx-auto mb-4 w-12 h-12 flex items-center justify-center rounded-full bg-blue-600 text-white text-xl font-bold hover:-translate-y-2 transition duration-300">
              {step.id}
            </div>
